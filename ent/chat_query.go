...
// Returns a *NotSingularError when exactly one Chat entity is not found.
...
// Returns a *NotSingularError when exactly one Chat ID is not found.
	...
	if query := cq.withMembers; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(chat.MembersPrimaryKey[0], fks...))
			},
